...
namespace Drupal\social_group_staging\Access;
 ...
 */
class GroupStatusPermissionAccessCheck implements AccessInterface {
  ...
  public function access(Route $route, RouteMatchInterface $route_match, AccountInterface $account) {
    $permission = $route->getRequirement('_group_status_permission');
    ...
    // An extra check for inactive groups.
    if ($group->get('group_access_status')->value === 'inactive') {
      $permissions = [
        'bypass group access',
